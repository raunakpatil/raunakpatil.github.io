  ...
  return (
    <section ref={ref} className="relative min-h-[1000vh] bg-transparent text-white z-10 pointer-events-none">
      ...
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden w-full font-['Space_Grotesk']">
        ...
        {/* Phase 2: Mystery */}
        <motion.div style={{ opacity: op2 }} className="absolute w-full max-w-4xl text-center z-10 p-8">
          <div className="space-y-8 drop-shadow-[0_0_40px_rgba(0,0,0,1)]">
        ...
        {/* Phase 3: Reveal */}
        <motion.div style={{ opacity: op3 }} className="absolute w-full max-w-4xl text-center z-10 p-8">
        ...
        <motion.div style={{ opacity: op4 }} className="absolute w-full h-full flex flex-col justify-center items-end pr-[10%] md:pr-[20%] z-10 pointer-events-none">
        ...
        <motion.div style={{ opacity: op5 }} className="absolute w-full h-full flex flex-col justify-center items-start pl-[10%] md:pl-[20%] z-10 pointer-events-none">
        ...
        {/* Phase 6: Convergence */}
        <motion.div style={{ opacity: op6 }} className="absolute w-full max-w-5xl text-center z-10 p-8 pointer-events-none">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <motion.div style={{ opacity: zummitOp }} className="text-center z-20 transform -translate-y-16">
          ...
          <motion.div style={{ opacity: metricsOp }} className="absolute inset-0 w-full h-full z-10">
