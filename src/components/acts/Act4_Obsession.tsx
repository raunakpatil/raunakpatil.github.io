  ...
  return (
    <section ref={ref} className="relative h-[200vh] bg-transparent text-white z-10 pointer-events-none">
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center overflow-hidden px-6">
        ...
        <motion.div style={{ opacity: opacity1 }} className="will-change-transform absolute max-w-[95vw] md:max-w-6xl text-center z-10 p-6 md:p-12 drop-shadow-[0_0_15px_rgba(0,0,0,1)]">
          <div className="leading-relaxed text-white flex flex-col items-center gap-2 md:gap-4 w-full">
            <span className="font-light tracking-wide text-base md:text-xl lg:text-2xl">I didn't just want to write scripts. I wanted to build ecosystems. Moving to</span>
            ...
            <span className="font-light tracking-wide text-base md:text-xl lg:text-2xl">for my Master's exposed me to the scale of global systems.</span>
          </div>
        </motion.div>
      </div>
    </section>
